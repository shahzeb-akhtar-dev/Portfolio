...
.my-work .tabs .work-cards {
  column-count: 3;
  column-gap: 2rem;
}

.my-work .tabs .work-cards li {
  list-style: none;
  padding-bottom: 2rem;
  position: relative;
}

.my-work .tabs .work-cards li img {
  width: 100%;
  object-fit: cover;
  border-radius: 2rem;
...
.my-work .tabs .work-cards li .overlay {
...
.my-work .tabs .work-cards li .overlay .name {
  display: block;
  cursor: pointer;
  font-weight: 600;
  margin: 1rem 0rem;
...
.my-work .tabs .work-cards li .overlay .name a {
  color: inherit;
}

.my-work .tabs .work-cards li .overlay .name:hover {
  text-decoration: underline;
}

.my-work .tabs .work-cards li .overlay .desc {
  display: -webkit-box;
  -webkit-line-clamp: 2;
...
.my-work .tabs .work-cards li:hover .overlay {
  height: 35%;
}
</style>
